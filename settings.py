...
class Ui_settings(object):
    def setupUi(self, settings):
        ...
        settings.resize(307, 363)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(settings.sizePolicy().hasHeightForWidth())
        settings.setSizePolicy(sizePolicy)
        settings.setMinimumSize(QtCore.QSize(307, 363))
        settings.setMaximumSize(QtCore.QSize(307, 363))
        ...
        self.groupBox_2.setMinimumSize(QtCore.QSize(0, 152))
...
"")
        ...
        self.groupBox.setMinimumSize(QtCore.QSize(267, 127))
